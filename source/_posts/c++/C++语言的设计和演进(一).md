...
| 版本 | 修改内容 | 日期 | 作者 |
|-------|-------|-------|-------|
| 0.1 | 新建文档，编写文章大纲以及前言部分 | 2025/10/20 | 杨超 |
| 0.2 | 完成第二章，以及提交github | 2025/11/26 | 杨超 |
...
近来有个感觉就是，最好的学习其实是输出，所以我计划在阅读过程中，将一些我认为重要的内容，以博客的形式输出出来，一方面加深自己的理解，另一方面也希望能能由感兴趣的人遇到。此篇是这个系列的第一篇，主要结合书的序言以及第0章内容做个总结以及谈谈自己的想法。
